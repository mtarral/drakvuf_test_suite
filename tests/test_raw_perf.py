# This simple test selects only bsodmon plugin, to avoid
# performance hits and to be used to benchmark a binary execution speed,
# in order to compare the performance cost of procmon and filetracer (or any
# other additional plugin) in test_injection.
...
# where we can know when the binary has finished its execution without introspection
